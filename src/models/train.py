...
# step 2 save the model, that's it for this python file
import pandas as pd
import yaml
import joblib
import logging
...
if __name__ == "__main__":
    ...
    # what it does ki ye y_train ko transform krke uspr training krta h 
    # and then prediction ke time pr inverse_transform krke results deta h 
