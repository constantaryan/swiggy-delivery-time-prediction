...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='constantaryan', repo_name='swiggy-delivery-time-prediction', mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/constantaryan/swiggy-delivery-time-prediction.mlflow")
...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
        ...
        # log the final model
        model_info = mlflow.sklearn.log_model(sk_model=model,name="delivery_time_pred_model",signature=model_signature)
        model_uri = model_info.model_uri
        
        logger.info(f"Logged model at URI: {model_uri}")
